...
class Timepicker_datetime {

    public function input_form($input_array)
    {
        if($input_array['value'] != 0) {
            $input_array['value'] = DateTime::createFromFormat('Y-m-d H:i:s', $input_array['value'])->format('d.m.Y H:i:s');
        } else {
    ...
    {
        return DateTime::createFromFormat('d.m.Y H:i:s', $input_array['value'])->format('Y-m-d H:i:s');
    }

    public function crud_view($input_array)
    {
        if ($input_array['value'] != 0) {
            return DateTime::createFromFormat('Y-m-d H:i:s', $input_array['value'])->format('d.m.Y H:i:s');
        } else {
